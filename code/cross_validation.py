...
def create_test_and_train_cross_val_folds(synergy_df, cross_val_type,  number_of_folds=5, neg_fact = 1, test_frac = 0.2):
    # this function will split the indexes in synergy_df into 'number_of_folds' according to\
    # the cross_val_type
    # return a dictionary of folds. key = fold_no, value= list of indices
    cell_lines = synergy_df['Cell_line'].unique()
...
#
# def train_test_split(synergy_df, cross_val_type,  test_frac, cross_val_dir, force_run=True ):
#     train_file_name = cross_val_dir + '/train.tsv'
#     test_file_name = cross_val_dir + '/test.tsv'
#
