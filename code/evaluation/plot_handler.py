...
def plot(should_run_algs, config_map):
        ...
        for run_ in range(number_of_runs):
            ...
            if alg == 'decagon':
                ...
                for drug_feat_option in use_drug_feat_options:
                    pos_out_file = out_dir + 'run_' + str(run_) + '/' + '/pos_val_scores' + '_drugfeat_' + str(
                        drug_feat_option) + \
                                   '_e_' + str(epochs) + '_lr_' + str(lr) + '_batch_' + str(batch_size) + '_dr_' + str(
                        dr) + '.tsv'
                    neg_out_file = out_dir + 'run_' + str(run_) + '/' + '/neg_val_scores' + '_drugfeat_' + str(
                        drug_feat_option) + \
                                   '_e_' + str(epochs) + '_lr_' + str(lr) + '_batch_' + str(batch_size) + '_dr_' + str(
                        dr) + '.tsv'
            ...
            if alg == 'synverse':
                ...
                for drug_feat_option in use_drug_feat_options:
                    pos_out_file = out_dir + 'run_' + str(run_) + '/' + '/pos_val_scores' + '_hsize_' + str(
                        h_sizes) + '_drugfeat_' + str(
                        drug_feat_option) + '_e_' + str(epochs) + '_lr_' + str(lr) + '_batch_' + str(
                        batch_size) + '_dr_' + str(dr) + '.tsv'
                    neg_out_file = out_dir + 'run_' + str(run_) + '/' + '/neg_val_scores' + '_hsize_' + str(
                        h_sizes) + '_drugfeat_' + str(
                        drug_feat_option) + '_e_' + str(epochs) + '_lr_' + str(lr) + '_batch_' + str(
                        batch_size) + '_dr_' + str(dr) + '.tsv'
                ...
                for layer_setup in layer_setups:
                    for lr in lrs:
                        for in_hid_dropout in in_hid_dropouts:
                            ...
                            pos_out_file = out_dir + 'run_' + str(run_) + '/' + '/pos_val_scores' + '_layers_' + str(
                                layer_setup) + '_e_' + str(
                                epochs) + '_lr_' + str(lr) + '_batch_' + str(batch_size) + '_dr_' + \
                                           str(input_dropout) + '_' + str(dropout) + '_act_' + str(act_func) + '.tsv'

                            neg_out_file = out_dir + 'run_' + str(run_) + '/' + '/neg_val_scores' + '_layers_' + str(
                                layer_setup) + '_e_' + str(
                                epochs) + '_lr_' + str(lr) + '_batch_' + str(batch_size) + '_dr_' + \
                                           str(input_dropout) + '_' + str(dropout) + '_act_' + str(act_func) + '.tsv'
                            pos_df = pd.read_csv(pos_out_file, sep='\t')
...
plot(['synverse','deepsynergy'],config_map)