...
def setup_opts():
    ...
    group.add_argument('--config', type=str, default="/home/grads/tasnina/Projects/SynVerse/code/"
                       "config_files/experiment_1/mlp_dtarget_c1hot.yaml",
...
def run_SynVerse(inputs, params, **kwargs):
   ...
   #********************************** GET FEATURES READY *******************************************************
    ...
    dfeat_preprocess = {f['name']: f['preprocess'] for f in drug_features}
    dfeat_norm = {f['name']: f['norm'] for f in drug_features}
    ...
    if 'target' in dfeat_names:
        ...
        if dfeat_preprocess['target']=='rwr':
            ...
            dfeat_dict['target'] = rwr_target_feat_df
            dfeat_dim_dict['target'] = rwr_target_feat_df.shape[1] - 1

        else:
            dfeat_dict['target'] = target_feat_df
            dfeat_dim_dict['target'] = target_feat_df.shape[1] - 1
