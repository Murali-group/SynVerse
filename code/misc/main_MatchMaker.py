...
from preprocessing.autoencoder import *
...
def setup_opts():
    ...
    group.add_argument('--config', type=str, default="/home/grads/tasnina/Projects/SynVerse/code/"
                       "config_files/experiment_1/MatchMaker.yaml",
   ...
   #********************************** GET FEATURES READY *******************************************************
    ...
    for run_no in range(start_run, end_run):
        for split in splits:
            ...
            cur_dfeat_dict['value'], cur_dfeat_dict['dim'] = autoencoder_runner(cur_dfeat_dict['value'], cur_dfeat_dict['dim'], cur_dfeat_dict['compress'],
            ...
            cur_cfeat_dict['value'], cur_cfeat_dict['dim'] = autoencoder_runner(cur_cfeat_dict['value'], cur_cfeat_dict['dim'], cur_cfeat_dict['compress'],
            ...
            for (select_drug_feat, select_cell_feat) in drug_cell_feat_combs:
                ...
                runner = Runner(all_train_df, train_idx, val_idx, select_dfeat_dict, select_cfeat_dict,
...
def main(config_map, **kwargs):
    ...
    # inputs.smean_processed_syn_file = input_dir + 'synergy/MatchMaker.tsv'
