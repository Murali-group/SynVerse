...
from models.pretrained.kpgt.src.data.featurizer import VIRTUAL_ATOM_FEATURE_PLACEHOLDER, VIRTUAL_BOND_FEATURE_PLACEHOLDER
...
class LiGhTPredictor(nn.Module):
    ...
    #returning features, not model head
