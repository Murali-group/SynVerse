...
def save_val_eval(val_f1_macro,val_f1_micro, val_precision, val_recall, model_info, use_genex, use_target, out_dir):
...
def run_svm_model(drug_maccs_keys_targets_feature_df,drug_maccs_keys_feature_df,\
    ...
    save_val_eval(val_f1_macro, val_f1_micro, val_precision_macro, val_recall_macro, model_info, use_genex, use_target, out_dir)
