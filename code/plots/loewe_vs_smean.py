...
def main():
    plot_dir = "/home/grads/tasnina/Projects/SynVerse/inputs/stat/"
    split_dir = "/home/grads/tasnina/Projects/SynVerse/inputs/splits/"
    feature_prefixes = ['D_ECFP_4_MACCS_MFP_d1hot_mol_graph_smiles_C_c1hot', 'D_d1hot_target_C_c1hot']
    split_types = ['leave_drug', 'leave_comb']
    ...
    for feature_prefix in feature_prefixes:
        for split_type in split_types:
            ...
            if combined_data:
                ...
                out_file = f'{plot_dir}/{split_type}_{feature_prefix}_dual_score_distribution.pdf'
                plot_violin(combined_df, out_file)
