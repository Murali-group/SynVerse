...
#08/16/2021 14:10
#python main.py --config "/home/tasnina/Projects/SynVerse/code/config-files/master_config_csbgpu3.yaml" --sampling 'semi_random' --train --use-genex

#running svm
#8/29/2021
#python main.py --config "/home/tasnina/Projects/SynVerse/code/config-files/master_config_csbgpu3.yaml" --sampling 'semi_random' --train --use-genex --use-target

python main_with_test.py --config "/home/tasnina/Projects/SynVerse/code/config-files/master_config_csbgpu3.yaml" --sampling 'semi_random' --train